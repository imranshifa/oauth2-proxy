...
// A implementation of configStore interface, defined for texting scenarios where
...
// function looks for implementation of Update func and returns nil if not found.
...
// Get implements ConfigStore interface function Get and returns nil if no
